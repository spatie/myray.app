...
gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger); // ANiMATION HERO

function setupTypewriter(t) {
  var event = new CustomEvent("".concat(t.id, "_finished"));
  var HTML = t.innerHTML.replace(/&gt;/g, ">");
  t.innerHTML = "";
...
var typer0 = document.getElementById('typewriter_0');
var typer1 = document.getElementById('typewriter_1');
var typer2 = document.getElementById('typewriter_2');
var typewriter0 = setupTypewriter(typer0);
var typewriter1 = setupTypewriter(typer1);
var typewriter2 = setupTypewriter(typer2); // SETUP GSAP TIMELINES

var heroTimeline1 = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline();
...
var heroTimeline3 = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline();
heroTimeline3.fromTo('.ray-line-03', {
  ...
  duration: .1,
  ease: gsap__WEBPACK_IMPORTED_MODULE_3__.Power3.easeOut
}).pause(); // START TYPING FIRST TYPER And LISTEN WHEN DONE

typewriter0.type();
window.addEventListener('typewriter_0_finished', function () {
  heroTimeline1.play();
});
window.addEventListener('typewriter_1_finished', function () {
  heroTimeline2.play();
});
window.addEventListener('typewriter_2_finished', function () {
  heroTimeline3.play();
...
var scrollTestimonialsDown = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline();
scrollTestimonialsDown.to('.testimonial-down', {
  y: '-100%',
  duration: 100,
  ease: gsap__WEBPACK_IMPORTED_MODULE_3__.Power0.easeNone
}).pause();
var scrollTestimonialsUp = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline();
...
var showMoreTestimonialsButton = document.getElementById('showMoreTestimonials');
var closeMoreTestimonialsButton = document.getElementById('closeMoreTestimonials');
showMoreTestimonialsButton.addEventListener('click', function () {
  window.addEventListener('wheel', handleMouseWheel); // Stop scrolling 
...
closeMoreTestimonialsButton.addEventListener('click', function () {
  ...
  timeLineOpenTestimonials.reverse(); // Stop scrolling 
