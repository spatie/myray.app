<div class="w-full overflow-hidden rounded-xl lg:min-w-[45rem] lg:h-[30rem] group/window"
            ...
            <div class="flex">
                ...
                <div>
                    ...
                    <x-animation.tooltip name="previous"
                        content="Clears your screen and archives all messages for reference later." />
                </div>
    ...
    <div class="bg-gradient-to-b from-[#14052E] to-[#1C0840] h-full static">
        ...
        <div class="flex gap-4 h-full w-full items-center justify-center absolute top-0 z-10 pointer-events-none">
        ...
        <div class="flex gap-6 px-6 py-4 border-b border-[#261A43]">
            <div class="my-2">
            ...
            <div class="leading-[1.4]">
                <div class="mb-2">
                    <p>You can just about send anything to Ray</p>
                </div>
                <div class="flex text-bleak-purple-extra-light text-sm gap-2">
                    <div>
                        <span class="underline">TestCommand.php:15</span>
            ...
            <div class="leading-[1.4]">
                <div class="mb-3">
                    <div class="border border-[#483A6C] rounded-md">
                        <div class="flex items-start gap-2 p-2 border-b border-[#483A6C]">
                            <div class="text-bleak-purple-extra-light text-sm min-w-24">Message</div>
                            <div>A simple table message</div>
                        </div>
