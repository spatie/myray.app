                        ...
                        <div class="mb-4 space-y-2">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-4">
                                    <h2 class="font-display font-black text-4xl">3.0.0</h2>
                                    <span
                            ...
                            <span class="text-sm text-bleak-purple-extra-light inline-block"><time datetime="2024-08-31 10:00">31 August 2024</time></span>
                        </div>
                        <div class="markup">
                            <p class="text-lg">
            ...
            <section class="rounded-2xl overflow-hidden flex-1 border border-bleak-purple-light">
                <div class="p-4 md:p-8 md:py-6">
                    <div class="mb-4 space-y-2">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                <h2 class="font-display font-black text-3xl">3.0.2</h2>
                                <span
                                    class="py-1 px-3 no-underline rounded-full bg-blue text-white font-semibold bg-midnight-extra-light text-sm">Latest release</span>
                            </div>
                        </div>
                        <span class="text-sm text-bleak-purple-extra-light inline-block"><time datetime="2024-08-31 10:00">31 August 2024</time></span>
                    </div>
            ...
            <section class="rounded-2xl overflow-hidden flex-1 border border-bleak-purple-light">
                <div class="p-4 md:p-8 md:py-6">
                    <div class="mb-4 space-y-2">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                <h2 class="font-display font-black text-3xl">3.0.1</h2>
                            </div>
                        </div>
                        <span class="text-sm text-bleak-purple-extra-light inline-block"><time datetime="2024-08-31 10:00">31 August 2024</time></span>
                    </div>
