...
We shall make sure that the latest version of these Terms of Use shall always be available on <https://myray.app/terms-of-use>.
...
1. “Fee”: the amount to be paid to Spatie to obtain a Software license. This fee shall always be available at <https://myray.app>;
2. “App”: the Ray application as a product listed and described on <https://myray.app>, including all present and future bug fixes, corrections, updates, upgrades, modifications, new features or functionalities and documentation;
3. "Software license": The non-exclusive, non-transferable, limited right to access, use and download the Ray application. The Software License expires one year after the payment of the Fee;
3. “Terms of Use”: these terms of use;
4. “You”: any user will buy the App and who will use it for educational purposes.

## 2. Content of the App

2.1. By accepting these Terms of Use, Spatie grants You access to the complete App after the payment of the Fee. You can always read the content of the App at: <https://myray.app>.

## 3. Purchase and download of the App

3.1. By paying the Fee, You consent to these Terms of Use. You cannot use or download the App without explicitly consenting to these Terms of Use.
...
5.1. Spatie may terminate or suspend your access to the App at any time, including in the event of your actual or suspected unauthorized use of the App or of non-compliance with these Terms of Use, without any liability.
...
5.4. As long as You use the App, these Terms of Use shall apply.
...
7.1. All payments concerning the purchase of the App shall be handled by [Paddle](https://paddle.com/) in accordance with its terms and conditions. Paddle handles all payments through <https://spatie.be/products> by using Paddle’s SDK. Spatie does not store any of your payment details.
...
9.5. To the extent permitted by applicable law, the maximum liability of Spatie for any damage resulting from the use of the App or related to these Terms of Use, whether contractual or extra-contractual, is limited to the actual direct damage.

## 10. Indemnification

10.1. You agree to indemnify and hold harmless Spatie, our affiliates and our officers, directors, employees, stockholders, agents and representatives from any and all third party claims, liability, damages and/or costs (including, but not limited to, reasonable attorney and legal fees and expenses) arising from your improper use of our app, your violation of these Terms of Use, or your infringement, or the infringement or use by any other user of your account in relation to our app (for example: the infringement of any intellectual property).

## 11. Third-Party Licenses

11.1. Specific components that are shown in the App may be provided under third party licenses or MIT licenses and may be subject to other terms and conditions as those of these Terms of Use.

11.2. You shall be required to obtain for yourself all licenses for third-party software not included within the App. Spatie does not assume any responsibility in case of infringement of such third party license terms of use by You.
