...
<x-layouts.default
    ...
    <div class="border-b border-white border-opacity-10">
        <div class="container mx-auto py-12 px-6 md:py-24 lg:px-16">
            ...
            <div class="flex flex-col md:flex-row gap-8 md:gap-16" x-data="{ activeTab: 0 }">
                ...
                <ul class="text-lg order-1 md:order-2 md:max-w-[400px]">
                    <li :class="activeTab === 0 ? 'shadow-large-drop' : 'opacity-50'" class="transition hover:opacity-100 rounded-2xl">
                        <button @click="activeTab = 0" class="relative p-8 space-y-2 rounded-2xl text-left overflow-hidden w-full">
                            <div class="absolute inset-0 bg-gradient-to-r from-orange to-bright-orange rounded-2xl transition-opacity duration-500 ease-in-out"
                                 :class="activeTab === 0 ? 'opacity-100' : 'opacity-0'"></div>
                            <div class="relative z-10 space-y-2">
                                <h3 class="font-display font-bold text-2xl">HTML components</h3>
                                <p :class="activeTab === 0 && 'font-bold'">Let your AI generate HTML components or prototypes and interact with them directly inside Ray.</p>
                            </div>
                        </button>
                    </li>
                    <li :class="activeTab === 1 ? 'shadow-large-drop' : 'opacity-50'" class="transition hover:opacity-100 rounded-2xl">
                ...
                <div class="w-full flex rounded-3xl overflow-hidden shadow-large-drop order-2 md:order-1">
                    <div class="relative w-full bg-gradient-to-b from-neutrals-white-20 to-transparent p-3 shadow-top-white max-md:aspect-square">
                        <div class="absolute inset-3 px-3 z-10 overflow-hidden md:px-12" x-ref="carousel">
                            <div class="flex flex-col transition-transform duration-700 ease-in-out h-full"
                                 :style="`transform: translateY(calc(-${activeTab} * ${$refs.carousel?.clientHeight || 0}px))`">
    ...
    <div class="hidden lg:block absolute w-full pointer-events-none overflow-hidden -translate-y-1/2 -z-10" style="height: 451px;">
        <svg class="mx-auto" width="1280" height="451" viewBox="0 0 1280 451" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M264.984 268.866L364.266 446.359L231.294 324.856L264.984 268.866Z" stroke="url(#paint0_linear_2125_4467)" stroke-width="1.57538" stroke-miterlimit="10"/>
            <path d="M1086.54 2.04748L1211.89 292.34L1178.85 45.9237L1086.54 2.04748Z" stroke="url(#paint1_linear_2125_4467)" stroke-width="1.57538" stroke-miterlimit="10"/>
            <path d="M7.80521 58.0042L256.392 162.444L10.3416 158.221L7.80521 58.0042Z" stroke="url(#paint2_linear_2125_4467)" stroke-width="1.57538" stroke-miterlimit="10"/>
    ...
    <div class="container mx-auto py-12 px-6 md:py-24 lg:px-16">
        ...
        <div class="max-w-prose mx-auto mb-8 md:mb-16 text-center">
            <h2 class="font-display font-bold text-4xl/[1.15] text-balance">Cool things Ray can do</h2>
        </div>
    ...
    <div class="bg-bright-purple p-6 lg:py-24 border-b border-t border-white border-opacity-15">
        ...
        <div class="relative" x-data="{ showLoveLetter: true }">

            <div class="absolute inset-0 -left-6 -top-2 bg-midnight lg:max-w-prose mx-auto border border-bleak-purple-light rounded-md shadow-large-drop overflow-hidden h-fit">
                <div class="flex items-center px-3 gap-2 bg-white bg-opacity-10 h-8 border-b border-bleak-purple-light">
                    <div class="bg-bleak-purple-extra-light rounded-full w-3 h-3 cursor-pointer hover:bg-red-500 transition-colors" @click="showLoveLetter = true"></div>
                    <div class="bg-bleak-purple-extra-light rounded-full w-3 h-3"></div>
                    <div class="bg-bleak-purple-extra-light rounded-full w-3 h-3"></div>
                    <span class="absolute left-0 w-full text-center text-sm text-white text-opacity-50 font-bold">FreekSecretDumpCakeRecipe.md</span>
                </div>
                <div class="p-8 lg:p-12">
                    <h2 class="font-display font-black text-3xl leading-[1] mb-[0.5em] text-balance md:text-5xl">Freek's Secret
                    <span class="bg-gradient-to-r from-orange to-bright-orange text-transparent bg-clip-text pb-1 md:block">Dump Cake Recipe</span>
                    </h2>
                    <div class="text-lg leading-snug mb-8 space-y-3">
                        <p><strong>Ingredients:</strong> 1 box vanilla cake mix, 1 can (570g / 20 oz) crushed pineapple with juice, 115g / 1/2 cup melted butter.</p>
                        <p><strong>Instructions:</strong></p>
                        <ol class="list-decimal list-inside space-y-1">
                            <li>Dump pineapple into a 23x33cm / 9x13" pan.</li>
                            <li>Dump cake mix on top.</li>
                            <li>Drizzle with melted butter.</li>
                            <li>Bake at 180°C / 350°F for 45 minutes until golden.</li>
                        </ol>
                        <p><strong>The spice:</strong> Dust with cinnamon and a pinch of nutmeg before serving. Add a dollop of whipped cream if you're feeling fancy.</p>
                    </div>
                </div>
            </div>

            <div class="bg-midnight lg:max-w-prose mx-auto border border-bleak-purple-light rounded-md shadow-large-drop overflow-hidden transition-opacity duration-300" :class="showLoveLetter ? 'opacity-100' : 'opacity-0 pointer-events-none'">
                <div class="flex items-center px-3 gap-2 bg-white bg-opacity-10 h-8 border-b border-bleak-purple-light">
                    <div class="bg-bleak-purple-extra-light rounded-full w-3 h-3 cursor-pointer hover:bg-red-500 transition-colors" @click="showLoveLetter = false"></div>
                    <div class="bg-bleak-purple-extra-light rounded-full w-3 h-3"></div>
                    <div class="bg-bleak-purple-extra-light rounded-full w-3 h-3"></div>
                    <span class="absolute left-0 w-full text-center text-sm text-white text-opacity-50 font-bold pointer-events-none">LoveLetter.md</span>
                </div>
                <div class="p-8 lg:p-12">
